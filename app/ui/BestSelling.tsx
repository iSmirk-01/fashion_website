...
function BestSelling() {
  return (
    <div className="w-full min-h-[100vh] flex flex-col  items-center justify-center mx-auto">
      <div className="w-[80%] h-full flex flex-col gap-10 items-center">
        <div className="flex flex-col justify-center items-center gap-9 text-greenDark">
        ...
        <button className="flex gap-3 items-center border-2 border-greenDark px-9 py-2 my-5 text-greenDark w-max">
