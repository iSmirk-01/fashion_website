...
function Hero() {
  return (
    <div className="bg-lime min-h-[775] w-full grid grid-cols-1 lg:grid-cols-2 place-items-center px-20">
      <div className="flex flex-col justify-center items-start p-8 h-full gap-10 px-8">
        <h1 className={`${rufina.className} text-greenDark text-7xl/normal`}>Discover and Find Your Own Fashion!</h1>
