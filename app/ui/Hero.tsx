...
function Hero() {
  return (
    <div className="bg-lime h-full w-full grid grid-cols-1 md:grid-cols-2 place-items-center px-20">
      <div className="flex flex-col justify-center items-start p-8 h-full gap-10 px-8">
        <h1 className={`${rufina.className} text-greenDark text-7xl`}>Discover and Find Your Own Fashion!</h1>
        <p className='text-green prose font-semibold'>
