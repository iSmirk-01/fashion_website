...
function Hero() {
  return (
    <div className="bg-lime min-h-[700px] w-full grid grid-cols-1 lg:grid-cols-2 place-items-center px-4 gap-8 py-20 overflow-x-hidden">
      <div className="flex flex-col justify-center items-center md:items-start p-8 h-full gap-10 px-8 w-full">
        <h1 className={`${rufina.className} text-greenDark text-3xl/normal sm:text-7xl/normal md:text-8xl/normal px-4 md:px-0 max-w-[500px] max-h-max self-center md:self-start`}>Discover and Find Your Own Fashion!</h1>
